...
module Assembla
  class Client::Issues < API
    ...
    require_all 'assembla_api/client/issues',
      'assignees',
      'comments',
      'events',
      'labels',
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.issues.list :user
    #
    # List all issues for a given organization for the authenticated user.
    #
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.issues.list org: 'org-name'
    #
    # List issues for a repository
    #
    # @example
    #  assembla = Assembla.new
    #  assembla.issues.list user: 'user-name', repo: 'repo-name'
    #
    # @param [Hash] params
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.issues.list since: '2011-04-12T12:12:12Z',
    #    filter: 'created',
    #    state: 'open',
    #    labels: "bug,ui,bla",
    #    sort: 'comments',
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.issues.get 'user-name', 'repo-name', 'number'
    #
    def get(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.issues.edit 'user-name', 'repo-name', 'number'
    #    title: "Found a bug",
    #    body: "I'm having a problem with this.",
    #    assignee: "buildbot",
    #    milestone: 1,
