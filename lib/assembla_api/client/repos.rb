...
module Assembla
  class Client::Repos < API
    ...
    require_all 'assembla_api/client/repos',
      'collaborators',
      'comments',
      'commits',
      'contents',
    ...
    #   assembla.repos.list :every
    #   assembla.repos.list :every { |repo| ... }
    #
    # List public repositories for the specified user.
    #
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.list user: 'user-name'
    #   assembla.repos.list user: 'user-name', { |repo| ... }
    #
    # List repositories for the specified organisation.
    #
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.list org: 'org-name'
    #  assembla.repos.list org: 'org-name', { |repo| ... }
    #
    # @api public
    def list(*args)
      arguments(args) do
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.get 'user-name', 'repo-name'
    #  assembla.repos.get user: 'user-name', repo: 'repo-name'
    #  assembla.repos(user: 'user-name', repo: 'repo-name').get
    #
    def get(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.create "name": 'repo-name'
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.repos.create name: 'repo-name', org: 'organisation-name'
    #
    # @example
    def create(*args)
      arguments(args) do
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.repos.delete 'user-name', 'repo-name'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo])
    ...
    # @examples
    #  assembla = Assembla.new
    #  assembla.repos.contributors 'user-name','repo-name'
    #  assembla.repos.contributors 'user-name','repo-name' { |cont| ... }
    #
    # @api public
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.edit 'user-name', 'repo-name',
    #    name: 'hello-world',
    #    description: 'This is your first repo',
    #    homepage: "https://assembla.com",
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.branches 'user-name', 'repo-name'
    #   assembla.repos(user: 'user-name', repo: 'repo-name').branches
    #
    # @example
    #   repos = Assembla::Repos.new
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.branch 'user-name', 'repo-name', 'branch-name'
    #   assembla.repos.branch user: 'user-name', repo: 'repo-name', branch: 'branch-name'
    #   assembla.repos(user: 'user-name', repo: 'repo-name', branch: 'branch-name').branch
    # @api public
    def branch(*args)
    ...
    # @examples
    #  assembla = Assembla.new
    #  assembla.repos.languages 'user-name', 'repo-name'
    #  assembla.repos.languages 'user-name', 'repo-name' { |lang| ... }
    #
    # @api public
    def languages(*args)
      arguments(args, required: [:user, :repo])
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.tags 'user-name', 'repo-name'
    #   assembla.repos.tags 'user-name', 'repo-name' { |tag| ... }
    #
    # @api public
    def tags(*args)
      arguments(args, required: [:user, :repo])
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.teams 'user-name', 'repo-name'
    #   assembla.repos.teams 'user-name', 'repo-name' { |team| ... }
    #
    # @example
    #   assembla.repos(user: 'user-name, repo: 'repo-name').teams
    #
    # @api public
    def teams(*args)
      arguments(args, required: [:user, :repo])
