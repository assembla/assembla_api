...
module Assembla
  class Client::PullRequests::Comments < API
    ...
    #   assembla.pull_requests.comments.list 'user-name', 'repo-name', number: 'id'
    #
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.pull_requests.comments.list 'user-name', 'repo-name'
    #   assembla.pull_requests.comments.list 'user-name', 'repo-name' { |comm| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.pull_requests.comments.get 'user-name', 'repo-name', 'number'
    #
    # @example
    #   assembla.pull_requests.comments.get
    #     user: 'user-name',
    #     repo: 'repo-name',
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.pull_requests.comments.create 'user-name', 'repo-name', 'number',
    #    body: "Nice change",
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.pull_requests.comments.edit 'user-name', 'repo-name', 'number',
    #     body: "Nice change"
    #
    # @api public
    def edit(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.pull_requests.comments.delete 'user-name', 'repo-name', 'number'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :number])
