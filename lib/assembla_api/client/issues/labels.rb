...
module Assembla
  class Client::Issues::Labels < API
    ...
    #   assembla.issues.labels.list
    #   assembla.issues.labels.list { |label| ... }
    #
    # Get labels for every issue in a milestone
    #
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.list 'user-name', 'repo-name', milestone_id: 'milestone-id'
    #
    # List labels on an issue
    #
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.list 'user-name', 'repo-name', issue_id: 'issue-id'
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.find 'user-name', 'repo-name', 'label-name'
    #
    # @example
    #   assembla = Assembla.new user: 'user-name', repo: 'repo-name'
    #   assembla.issues.labels.get label_name: 'bug'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new user: 'user-name', repo: 'repo-name'
    #   assembla.issues.labels.create name: 'API', color: 'FFFFFF'
    #
    # @api public
    def create(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.update 'user-name', 'repo-name', 'label-name',
    ...
    # @examples
    #   assembla = Assembla.new
    #   assembla.issues.labels.delete 'user-name', 'repo-name', 'label-name'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :label_name])
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.add 'user-name', 'repo-name', 'issue-number',
    #     'label1', 'label2', ...
    #
    # @api public
    def add(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.remove 'user-name', 'repo-name', 'issue-number',
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.labels.replace 'user-name', 'repo-name', 'issue-number',
    #     'label1', 'label2', ...
    #
    # @api public
    def replace(*args)
