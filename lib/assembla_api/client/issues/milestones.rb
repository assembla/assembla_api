...
module Assembla
  class Client::Issues::Milestones < API
    ...
    #  assembla.issues.milestones.list
    #
    # @example
    #  assembla.issues.milestones.list state: 'open', sort: 'due_date',
    #    direction: 'asc'
    #
    # @api public
    def list(*args)
    ...
    #   assembla.issues.milestones.get 'user-name', 'repo-name', 'milestone-number'
    #
    # @example
    #   assembla.issues.milestones.get
    #     user: 'user-name',
    #     repo: 'repo-name',
    ...
    # @example
    #  assembla = Assembla.new user: 'user-name', repo: 'repo-name'
    #  assembla.issues.milestones.create title: 'hello-world',
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.milestones.update 'user-name', 'repo-name', 'number',
    #     :title => 'hello-world',
    #     :state => "open or closed",
    #     :description => "String",
    #     :due_on => "Time"
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.issues.milestones.delete 'user-name', 'repo-name', 'number'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :number])
