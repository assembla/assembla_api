...
module Assembla
  class Client::Repos::Downloads < API
    ...
    #   assembla.repos.downloads.list 'user-name', 'repo-name'
    #   assembla.repos.downloads.list 'user-name', 'repo-name' { |downl| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.downloads.get 'user-name', 'repo-name', 'download-id'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.downloads.delete 'user-name', 'repo-name', 'download-id'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :id])
