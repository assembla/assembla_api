...
module Assembla
  class Client::Repos::Commits < API
    ...
    #   Assembla login, name, or email by which to filter by commit author.
    ...
    #  assembla.repos.commits.list 'user-name', 'repo-name', sha: '...'
    #  assembla.repos.commits.list 'user-name', 'repo-name', sha: '...' { |commit| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.commits.get 'user-name', 'repo-name', '6dcb09b5b57875f334f61aebed6')
    #
    # @api public
    def get(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.commits.compare 'user-name', 'repo-name', 'v0.4.8', 'master'
    #
    # @api public
    def compare(*args)
