...
module Assembla
  ...
  class Client::Repos::Statuses < API
    ...
    #   assembla.repos.statuses.list 'user-name', 'repo-name', 'ref'
    #   assembla.repos.statuses.list 'user-name', 'repo-name', 'ref' { |status| ... }
    #
    # Get the combined Status for a specific Ref
    #
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.statuses.list 'user', 'repo', 'ref', combined: true
    #
    # @api public
    def list(*args)
    ...
    #   be linked from the Assembla UI to allow users to easily see
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.statuses.create 'user-name', 'repo-name', 'sha',
    #     state:  "success",
