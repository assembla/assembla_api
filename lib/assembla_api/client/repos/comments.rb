...
module Assembla
  class Client::Repos::Comments < API
    ...
    #  assembla.repos.comments.list 'user-name', 'repo-name'
    #
    # @example
    #  assembla.repos.comments.list 'user-name', 'repo-name' { |com| ... }
    #
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.comments.get 'user-name', 'repo-name', 'id'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.comments.create 'user-name', 'repo-name', 'sha-key',
    #    body: "Nice change",
    #    position: 4,
    #    line: 1,
    #    path: "file1.txt"
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.comments.update 'user-name', 'repo-name', 'id',
    #     body: "Nice change"
    #
    # @api public
    def update(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.comments.delete 'user-name', 'repo-name', 'id'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :id])
