...
module Assembla
  ...
  class Client::Repos::Contents < API
    ...
    #   assembla.repos.contents.readme 'user-name', 'repo-name'
    #
    #   content = Assembla::Repos;:Contents.new user: 'user-name', 'repo-name'
    #   content.readme
    #
    # @api public
    def readme(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.contents.get 'user-name', 'repo-name', 'path'
    #
    # @example
    #   assembla = Assembla.new user: 'user-name', repo: 'repo-name'
    #   assembla.repos.contents.get path: 'README.md'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.contents.create 'user-name', 'repo-name', 'path',
    #     path: 'hello.rb',
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.contents.update 'user-name', 'repo-name', 'path',
    #     path: 'hello.rb',
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.contents.delete 'user-name', 'repo-name', 'path',
    #    path: 'hello.rb',
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.contents.archive 'user-name', 'repo-name',
