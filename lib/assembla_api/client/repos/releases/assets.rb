...
module Assembla
  ...
  class Client::Repos::Releases::Assets < API
    ...
    #   assembla.repos.releases.assets.list 'owner', 'repo', 'id'
    #   assembla.repos.releases.assets.list 'owner', 'repo', 'id' { |asset| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.assets.get 'owner', 'repo', 'id'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.assets.upload 'owner', 'repo', 'id', 'file-path'
    #     name: "batman.jpg",
    ...
    def upload(*args)
      ...
      options = {
        ...
        endpoint: 'https://uploads.assembla.com',
    ...
    def infer_media(filepath)
      ...
      raise Assembla::Error::UnknownMedia.new(filepath)
    end
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.assets.edit 'owner', 'repo', 'id',
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.assets.delete 'owner', 'repo', 'id'
    #
    # @api public
    def delete(*args)
