...
module Assembla
  class Client::Repos::Deployments < API
    ...
    PREVIEW_MEDIA = 'application/vnd.assembla.cannonball-preview+json'.freeze # :nodoc:

    # List deployments on a repository
    #
    # @xample
    #  assembla = Assembla.new
    #  assembla.repos.deployments.list 'user-name', 'repo-name'
    #  assembla.repos.deployments.list 'user-name', 'repo-name' { |deployment| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.deployments.create 'user-name', 'repo-name', ref: '...'
    #  assembla.repos.deployments.create
    #     'user-name',
    #     'repo-name',
    #     ref: '...',
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.deployments.statuses 'user-name', 'repo-name', DEPLOYMENT_ID
    #  assembla.repos.deployments.statuses 'user-name', 'repo-name', DEPLOYMENT_ID { |status| ... }
    #
    # @api public
    def statuses(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.deployments.create_status 'user-name', 'repo-name', DEPLOYMENT_ID, state: '...'
    #
    # @api public
