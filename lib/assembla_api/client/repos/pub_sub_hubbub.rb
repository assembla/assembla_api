...
module Assembla
  class Client::Repos::PubSubHubbub < API
    ...
    #   Required string. The URI of the Assembla repository to subscribe to.
    ...
    #  assembla.repos.pubsubhubbub.subscribe
    #    'https://assembla.com/:user/:repo/events/push',
    #    'assembla://Email?address=peter-murach@gmail.com',
    #    verify: 'sync',
    #    secret: '...'
    #
    # @api public
    ...
    # @param [Hash] params
    # @input params [String] :topic
    #   Required string. The URI of the Assembla repository to
    ...
    # @example
    #   assembla = Assembla.new oauth_token: 'token'
    #   assembla.repos.pubsubhubbub.unsubscribe
    #     'https://assembla.com/:user/:repo/events/push',
    #     'assembla://Email?address=peter-murach@gmail.com',
    #     verify: 'sync',
    #     secret: '...'
    ...
    #   assembla.repos.pubsubhubbub.subscribe_service 'user-name', 'repo-name',
    #    'campfire',
    #     subdomain: 'assembla',
    #     room: 'Commits',
    #     token: 'abc123',
    ...
    def subscribe_service(*args)
      ...
      callback = "assembla://#{arguments.service}?#{params.serialize}"
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.repos.pubsubhubbub.unsubscribe_service 'user-name', 'repo-name',
    #     'campfire'
    #
    # @example
    #   assembla.repos.pubsubhubbub.unsubscribe_service
    #     user: 'user-name',
    #     repo: 'repo-name',
    ...
    def unsubscribe_service(*args)
      ...
      event    = params.delete('event') || 'push'
      topic    = "#{site}/#{arguments.user}/#{arguments.repo}/events/#{event}"
      callback = "assembla://#{arguments.service}"
