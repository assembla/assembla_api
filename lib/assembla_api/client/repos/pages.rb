...
module Assembla
  # The Pages API retrieves information about your Assembla Pages configuration,
  ...
  class Client::Repos::Pages < API
    ...
    #  assembla.repos.pages.list owner: 'owner-name', repo: 'repo-name'
    #
    #  assembla = Assembla.new
    #  assembla.repos.pages.list :latest, owner: 'owner-name', repo: 'repo-name'
    # @api public
    def list(*args)
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.pages.get owner: 'owner-name', repo: 'repo-name'
    #
    # @api public
    def get(*args)
      arguments(args, required: [:owner, :repo])
