...
module Assembla
  ...
  class Client::Repos::Releases < API
    ...
    require_all 'assembla_api/client/repos/releases', 'assets'
    ...
    #   assembla.repos.releases.list 'owner', 'repo'
    #   assembla.repos.releases.list 'owner', 'repo' { |release| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.get 'owner', 'repo', 'id'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.create 'owner', 'repo', 'tag-name',
    #     tag_name: "v1.0.0",
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.edit 'owner', 'repo', 'id',
    #     tag_name: "v1.0.0",
    #     target_commitish: "master",
    #     name: "v1.0.0",
    #     body: "Description of the release",
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.releases.delete 'owner', 'repo', 'id'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:owner, :repo, :id]).params
