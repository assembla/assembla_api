...
module Assembla
  ...
  class Client::Repos::Hooks < API
    ...
    #   assembla.repos.hooks.list 'user-name', 'repo-name'
    #   assembla.repos.hooks.list 'user-name', 'repo-name' { |hook| ... }
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.hooks.get 'user-name', 'repo-name', 'hook-id'
    #
    # @api public
    def get(*args)
    ...
    #   the assembla-services repository. Booleans are stored internally
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.hooks.create 'user-name', 'repo-name',
    #     name:  "web",
    #     active: true,
    #     config: {
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.hooks.edit 'user-name', 'repo-name', 'hook-id',
    #    "name" => "campfire",
    #    "active" =>  true,
    #    "config" =>  {
    #      "subdomain" => "assembla",
    ...
    # @example
    #  assembla = Assembla.new
    #  assembla.repos.hooks.test 'user-name', 'repo-name', 'hook-id'
    #
    # @api public
    def test(*args)
      arguments(args, required: [:user, :repo, :id])
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.hooks.ping 'user-name', 'repo-name', 'hook-id'
    #
    # @api public
    def ping(*args)
      arguments(args, required: [:user, :repo, :id])
    ...
    # @example
    #   assembla = Assembla.new
    #   assembla.repos.hooks.delete 'user-name', 'repo-name', 'hook-id'
    #
    # @api public
    def delete(*args)
      arguments(args, required: [:user, :repo, :id])
