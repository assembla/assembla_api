...
module Assembla
  class Client::Orgs::Teams < API
    ...
    #   assembla.orgs.teams.list
    #
    # List teams
    #
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.list org: 'org-name'
    #
    # @api public
    def list(*args)
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.get 'team-id'
    #
    # @api public
    def get(*args)
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.create 'org-name',
    #     name: "new team",
    #     permission: "push",
    #     repo_names: [
    #       "assembla/dotfiles"
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.edit 'team-id',
    #    name: "new team name",
    #    permission: "push"
    #
    # @api public
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.delete 'team-id'
    #
    def delete(*args)
      arguments(args, required: [:id])
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.list_members 'team-id'
    #   assembla.orgs.teams.list_members 'team-id' { |member| ... }
    #
    # @api public
    ...
    # @example
    #   assembla = Assembla.new oauth_token: '...'
    #   assembla.orgs.teams.team_member? 'team-id', 'user-name'
    #
    # @api public
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.add_member 'team-id', 'user-name'
    #
    # @api public
    def add_member(*args)
      arguments(args, required: [:id, :user])
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.remove_member 'team-id', 'user-name'
    #
    # @api public
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.list_repos 'team-id'
    #
    # @api public
    def list_repos(*args)
      arguments(args, required: [:id])
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.team_repo? 'team-id', 'user-name', 'repo-name'
    #
    # @api public
    def team_repo?(*args)
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.add_repo 'team-id', 'user-name', 'repo-name'
    #
    # @api public
    def add_repo(*args)
      arguments(args, required: [:id, :user, :repo])
    ...
    # @example
    #  assembla = Assembla.new oauth_token: '...'
    #  assembla.orgs.teams.remove_repo 'team-id', 'user-name', 'repo-name'
    #
    # @api public
